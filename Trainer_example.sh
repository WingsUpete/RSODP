...
### GallatExt ###
python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExt
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth
...
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExt -t 0
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth -t 0
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m eval -e eval.pth

### GallatExt-2 (Concatenation scheme) ###
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExtFull
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m eval -e eval.pth

### GallatExt-3 (Leverage tuning) ###
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExt -re 0.2
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth -re 0.2
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m eval -e eval.pth -re 0.2

### GallatExt-4 (Unified graph) ###
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExt -u 1
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth -u 1
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m eval -e eval.pth -u 1

### GallatExt-5 (Shifting scheme) ###
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 1 -m train -tt pretrain -net GallatExt -re -2
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r model_save/20211201_01_48_38.pth -re -2
...
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt pretrain -net GallatExt -rar refAR.pth
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m train -tt retrain -r pretrained_model.pth
#python Trainer.py -dr data/ny2016_0101to0331/ -c 20 -gid 0 -m eval -e eval.pth
